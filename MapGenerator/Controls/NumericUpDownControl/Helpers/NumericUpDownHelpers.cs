...
namespace MapGenerator.Controls.NumericUpDownControl.Helpers
{
    ...
    static class SystemDateInfo
    {
        ...
        public static string LongTimePattern => dtfi.LongTimePattern;

        public static string AMDesignator => dtfi.AMDesignator;

        public static string PMDesignator => dtfi.PMDesignator;
    }
