    ...
    public class SimplexNoise
    {
        ...
        public int Seed
        {
            ...
            set
            {
                if (value == 0)
                {
                    m_Perm = new byte[PermOriginal.Length];
                    PermOriginal.CopyTo(m_Perm, 0);
                }
                else
                {
                    m_Perm = new byte[512];
        ...
        public float[] Calc1D(int width, float scale = 1)
        {
        ...
        public float[,] Calc2D(int width, int height, float scale = 1)
        {
        ...
        public float[,,] Calc3D(int width, int height, int length, float scale = 1)
        {
        ...
        public float CalcPixel1D(int x, float scale = 1)
        {
            return Generate(x * scale) * 128 + 128;
        }

        public float CalcPixel2D(int x, int y, float scale = 1)
        {
            return Generate(x * scale, y * scale) * 128 + 128;
        }

        public float CalcPixel3D(int x, int y, int z, float scale = 1)
        {
